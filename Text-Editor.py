...
filename =  None
curdir = "/Users/rakshithacharya/Desktop/TEST/"
...
def info():
    showinfo("Text Editor",'Created Using Python and tkinter')
...
class Test(Text):
    def __init__(self, master, **kw):
        ...
        self.tag_configure("sel", background = "black",foreground = "white") # checked
    ...
    def saveAs(self,event = None):
        ...
        f = filedialog.asksaveasfile(title = "Save As",initialdir=curdir,mode = 'w',defaultextension = '.txt',filetypes = types)
        t = self.get(0.0, END)
        try:
            if f == None:
    ...
    def openFile(self,event = None):
        ...
        f = dialog.askopenfile(initialdir=curdir,title = "Select File",mode = "r",defaultextension = '.txt',filetypes = types)
        if f == None:
